...
export default function Footer() {
  return (
    <div className="bg-black w-screen bg-opacity-70 h-10 fixed bottom-0">
      <div className="text-gray-400 align-middle justify-center flex h-full items-center text-3xl gap-1">
        ...
        <a href='https://twitter.com/Drumfishband' target="_blank"><AiOutlineTwitter className='hover:text-white'/></a>
